...
VALUES (
  ...
  (
    ...
    'Jackson and Sons',
    649,
    'President couple political sit create.',
    '/logos/logo4.png'
  ),
  (
    'miller-woods-hernandez',
    'Miller, Woods and Hernandez',
    444,
    'Including theory protect reveal energy himself probably. Test leave mother area however.',
    '/logos/logo4.png'
  ),
  (
    'arnold-berger-townsend',
    'Arnold, Berger and Townsend',
    795,
  ...
  (
    ...
    'Smith LLC',
    908,
    'Statement use per mission method. Order truth method.',
    NULL
  ),
  (
    'morgan-sullivan',
  ...
  (
    ...
    'Taylor, Yu and Lee',
    226,
    'Down bag serve. Officer season company.',
    '/logos/logo2.png'
  ),
  (
    'scott-smith',
  ...
  (
    ...
    'Garcia-Ray',
    217,
    'Laugh low follow fear. Politics main size fine.',
    '/logos/logo2.png'
  ),
  (
    'logan-miller',
  ...
  (
    'willis-henson-miller',
    'Willis, Henson and Miller',
    821,
  ...
  (
    'wiggins-frederick-boyer',
    'Wiggins, Frederick and Boyer',
    298,
  ...
  (
    'jackson-davila-conley',
    'Jackson, Davila and Conley',
    813,
    'Consider with build either.',
    '/logos/logo4.png'
  ),
  (
    'salas-group',
  ...
  (
    ...
    'Pugh Ltd',
    87,
    'Believe reflect perform TV son.',
    '/logos/logo2.png'
  ),
  (
    'carr-wells-jones',
    'Carr, Wells and Jones',
    27,
  ...
  (
    ...
    'Weber-Hernandez',
    681,
    'Contain product south picture scientist.',
    '/logos/logo4.png'
  );
